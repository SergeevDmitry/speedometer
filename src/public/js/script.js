...
let endICO = '2018-05-26', //countdown
  icoSumma = 33.7, //summa million USD
...
$(function() {
  $('.slider').slick({
    ...
    arrows: true,
    prevArrow:
      "<div class='circle-left'><i class='fas fa-angle-left'></i></div>",
    nextArrow:
    "<div class='circle-right'><i class='fas fa-angle-right'></i></div>",
    responsive: [
      {
        breakpoint: 750,
        settings: {
  ...
  Accordion.prototype.dropdown = function(e) {
    ...
    if (!e.data.multiple) {
      ...
      $el
        ...
        .slideUp()
        .parent()
        .removeClass('open active-question');
    }
  };
...
$(document).ready(function() {
  $(window).scroll(function() {
    ...
    if (scTop > 5600 && scTop < 8500) {
      $('.left-fixed-menu li').removeClass('left-fixed-menu-active');
      $('.menu6').addClass('left-fixed-menu-active');
    }
    if (scTop > 8500 && scTop < 9300) {
      $('.left-fixed-menu li').removeClass('left-fixed-menu-active');
...
function showFooterMenu(action) {
  if (action === true) {
    $('.footer-position-fixed').addClass('showFooter');
    ...
    $('.footer-position-fixed').removeClass('showFooter');
  }
}
...
setTimeout(function() {
  let speedometr = new Vivus('spd', {duration: 2000, start: 'autostart', file: '../img/1.svg', onReady: function (myVivus) {
  ...
  let greayLine = new Vivus('spd', {duration: 2000, start: 'autostart', file: '../img/2.svg', onReady: function (myVivus) {
...
function drawProgress() {
  ...
  function prg(x2, y2, icoS) {
    ...
    /*   sx1 = sx2;
      ...
      progressPath2.fill('rgba(255, 215, 0, 1)').stroke({width:4, color: 'rgba(255, 215, 0, 1)'})
      
      text.fill('rgba(255, 215, 0, 1)')
      text.center(cx, cy)
      text.text(`$${icoS}M`)
